---
title: "Check the DEGs of targets by GSFA vs other methods"
author: "Kaixuan Luo"
date: "2022-09-01"
output:
...
Check the gene loadings to see if the target genes in any of the factors P(F) > 0.95?
```{r}
F_pm <- gibbs_PM$F_pm
